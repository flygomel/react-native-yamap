...
var YaMap = /** @class */ (function (_super) {
    ...
    YaMap.prototype.getVisibleRegion = function (callback) {
        var callbackId = CallbacksManager_1.default.addCallback(callback);
        react_native_1.UIManager.dispatchViewManagerCommand(react_native_1.findNodeHandle(this), this.getCommand('getVisibleRegion'), [callbackId]);
    };
    ...
    YaMap.prototype.getProps = function () {
        var props = __assign(__assign({}, this.props), { onRouteFound: this.processRoute, onCameraPositionReceived: this.processCameraPosition, onVisibleRegionReceived: this.processVisibleRegion, userLocationIcon: this.props.userLocationIcon ? this.resolveImageUri(this.props.userLocationIcon) : undefined });
